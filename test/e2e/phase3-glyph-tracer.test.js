...
describe('generateSigil — Phase 3 glyph tracer (REND-04, D-36..D-39, D-46..D-48)', () => {
  ...
  it('records a render block { curve: false, glyph: true, idPrefix: null, title: false } as the last working key', () => {
    const { working } = generateSigil(STATEMENT, SATURN, { glyph: true });
    expect(working.render).toEqual({ curve: false, glyph: true, idPrefix: null, title: false });
